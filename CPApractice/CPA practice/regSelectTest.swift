...
class regSelectTest : UIViewController, MFMailComposeViewControllerDelegate {
    
    @IBOutlet weak var regPartOneButton: UIButton!
    
    override func viewDidLoad() {
        
        regPartOneButton.layer.masksToBounds = true
        regPartOneButton.layer.cornerRadius = 10
