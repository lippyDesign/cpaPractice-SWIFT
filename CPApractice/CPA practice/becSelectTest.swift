...
class becSelectTest : UIViewController, MFMailComposeViewControllerDelegate {
    
    @IBOutlet weak var becPartOneButton: UIButton!
    
    override func viewDidLoad() {
        
        becPartOneButton.layer.masksToBounds = true
        becPartOneButton.layer.cornerRadius = 10
