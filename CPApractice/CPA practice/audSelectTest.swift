...
class audSelectTest : UIViewController, MFMailComposeViewControllerDelegate {
    
    
    @IBOutlet weak var audPartOneButton: UIButton!
    
    override func viewDidLoad() {
        
        audPartOneButton.layer.masksToBounds = true
        audPartOneButton.layer.cornerRadius = 10
